            ...
            <div className='mx-16'>
                <div className='flex gap-6'>
                    ...
                    <div className='flex justify-between'>
                       ...
                       {
                            visible.oldPassword ? <VisibilityIcon onClick={()=>{setVisible({
                                ...visible,
                                oldPassword: !visible.oldPassword
                            })}} sx={{color: '#444','&:hover' : {
                                cursor: 'pointer'
                            }}}/> : <VisibilityOffIcon onClick={()=>{setVisible({
                                ...visible,
                                oldPassword: !visible.oldPassword
                            })}} sx={{color: '#444','&:hover' : {
                                cursor: 'pointer'
                    ...
                    <input type={visible.oldPassword ? 'password' : 'text'} value={data.oldPassword} onChange={(e) => {
                        setData({
                            ...data,
                ...
                <div className='flex flex-col gap-2 mt-5'>
                    <div className='flex justify-between'>
                        ...
                        {
                            visible.newPassword ? <VisibilityIcon onClick={()=>{setVisible({
                                ...visible,
                    ...
                    <input type="password" value={data.newPassword} onChange={(e) => {
                        setData({
                            ...data,
                ...
                <div className='flex flex-col gap-2 mt-5 '>
                    <div className='flex justify-between'>
                        ...
                        {
                            visible.confirmPassword ? <VisibilityIcon onClick={()=>{setVisible({
                                ...visible,
                    ...
                    <input type="password" value={data.confirmPassword} onChange={(e) => {
                        setData({
                            ...data,
                ...
                <div className='mt-4'>
                    <button className={disable ? 'bg-gray-400 text-white px-5 py-2 rounded-sm' : 'bg-blue-500 text-white px-5 py-2 rounded-sm hover:bg-blue-600'} onClick={handleChange} disabled={disable}>Save</button>
                </div>
                    </div>
                    <div className='flex-1'>
